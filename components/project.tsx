...
export default function Project({title,description,tags,imageUrl}:ProjectProps){
    ...
    return (
        ...
        >
             <section className=" bg-gray-100 max-w-[42rem] border rounded-lg border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600">
            <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pt-10 sm:pr-2 sm:max-w-[50%] flex flex-col h-full group-even:ml-[20rem]">
